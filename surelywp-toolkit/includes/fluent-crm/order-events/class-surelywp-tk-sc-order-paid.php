...
if ( ! class_exists( 'Surelywp_Tk_Sc_Order_Paid' ) ) {
	 ...
	 * @since   1.0.0
	 */
	class Surelywp_Tk_Sc_Order_Paid extends BaseTrigger {
		...
		public function __construct() {
			...
			$this->triggerName = 'surecart/order_paid';
		...
		public function getTrigger() {
			return array(
				...
				'label'       => esc_html__( 'SureCart - Order Paid', 'surelywp-toolkit' ),
				'description' => esc_html__( 'Occurs when an order\'s status changes to paid', 'surelywp-toolkit' ),
		...
		public function getSettingsFields( $funnel ) {
			...
			return array(
				'title'     => esc_html__( 'SureCart - Order Paid', 'surelywp-toolkit' ),
				'sub_title' => esc_html__( 'Occurs when an order\'s status changes to paid', 'surelywp-toolkit' ),
				'fields'    => array(
