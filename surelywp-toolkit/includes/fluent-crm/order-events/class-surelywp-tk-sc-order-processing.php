...
if ( ! class_exists( 'Surelywp_Tk_Sc_Order_Processing' ) ) {
	 ...
	 * @since   1.0.0
	 */
	class Surelywp_Tk_Sc_Order_Processing extends BaseTrigger {
		...
		public function __construct() {
			...
			$this->triggerName = 'surecart/order_made_processing';
		...
		public function getTrigger() {
			return array(
				...
				'label'       => esc_html__( 'SureCart - Order Processing', 'surelywp-toolkit' ),
				'description' => esc_html__( 'Occurs when an order\'s status changes to processing', 'surelywp-toolkit' ),
		...
		public function getSettingsFields( $funnel ) {
			...
			return array(
				'title'     => esc_html__( 'SureCart - Order Processing', 'surelywp-toolkit' ),
				'sub_title' => esc_html__( 'Occurs when an order\'s status changes to processing', 'surelywp-toolkit' ),
				'fields'    => array(
