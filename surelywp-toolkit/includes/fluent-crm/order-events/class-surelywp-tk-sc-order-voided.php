...
if ( ! class_exists( 'Surelywp_Tk_Sc_Order_Voided' ) ) {
	 ...
	 * @since   1.0.0
	 */
	class Surelywp_Tk_Sc_Order_Voided extends BaseTrigger {
		...
		public function __construct() {
			...
			$this->triggerName = 'surecart/order_voided';
		...
		public function getTrigger() {
			return array(
				...
				'label'       => esc_html__( 'SureCart - Order Cancelled', 'surelywp-toolkit' ),
				'description' => esc_html__( 'Occurs when an order\'s status changes to void', 'surelywp-toolkit' ),
		...
		public function getSettingsFields( $funnel ) {
			...
			return array(
				'title'     => esc_html__( 'SureCart - Order Cancelled', 'surelywp-toolkit' ),
				'sub_title' => esc_html__( 'Occurs when an order\'s status changes to void', 'surelywp-toolkit' ),
				'fields'    => array(
