...
if ( ! class_exists( 'Surelywp_Tk_Sc_Order_Delivered' ) ) {
	 ...
	 * @since   1.0.0
	 */
	class Surelywp_Tk_Sc_Order_Delivered extends BaseTrigger {
		...
		public function __construct() {
			...
			$this->triggerName = 'surecart/order_delivered';
		...
		public function getTrigger() {
			return array(
				...
				'label'       => esc_html__( 'SureCart - Order Delivered', 'surelywp-toolkit' ),
				'description' => esc_html__( 'Occurs when an order\'s shipment status changes to delivered', 'surelywp-toolkit' ),
		...
		public function getSettingsFields( $funnel ) {
			...
			return array(
				'title'     => esc_html__( 'SureCart - Order Delivered', 'surelywp-toolkit' ),
				'sub_title' => esc_html__( 'Occurs when an order\'s shipment status changes to delivered', 'surelywp-toolkit' ),
				'fields'    => array(
