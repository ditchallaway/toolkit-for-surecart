...
if ( ! class_exists( 'Surelywp_Tk_Sc_Order_Payment_Failed' ) ) {
	 ...
	 * @since   1.0.0
	 */
	class Surelywp_Tk_Sc_Order_Payment_Failed extends BaseTrigger {
		...
		public function __construct() {
			...
			$this->triggerName = 'surecart/order_payment_failed';
		...
		public function getTrigger() {
			return array(
				...
				'label'       => esc_html__( 'SureCart - Order Payment Failed', 'surelywp-toolkit' ),
				'description' => esc_html__( 'Occurs when an order\'s status changes to payment failed', 'surelywp-toolkit' ),
		...
		public function getSettingsFields( $funnel ) {
			...
			return array(
				'title'     => esc_html__( 'SureCart - Order Payment Failed', 'surelywp-toolkit' ),
				'sub_title' => esc_html__( 'Occurs when an order\'s status changes to payment failed', 'surelywp-toolkit' ),
				'fields'    => array(
