...
if ( ! class_exists( 'Surelywp_Tk_Sc_Order_Unfulfilled' ) ) {
	 ...
	 * @since   1.0.0
	 */
	class Surelywp_Tk_Sc_Order_Unfulfilled extends BaseTrigger {
		...
		public function __construct() {
			...
			$this->triggerName = 'surecart/order_unfulfilled';
		...
		public function getTrigger() {
			return array(
				...
				'label'       => esc_html__( 'SureCart - Order Unfulfilled', 'surelywp-toolkit' ),
				'description' => esc_html__( 'Occurs when an order\'s fulfillment status changes to unfulfilled', 'surelywp-toolkit' ),
		...
		public function getSettingsFields( $funnel ) {
			...
			return array(
				'title'     => esc_html__( 'SureCart - Order Unfulfilled', 'surelywp-toolkit' ),
				'sub_title' => esc_html__( 'Occurs when an order\'s fulfillment status changes to unfulfilled', 'surelywp-toolkit' ),
				'fields'    => array(
