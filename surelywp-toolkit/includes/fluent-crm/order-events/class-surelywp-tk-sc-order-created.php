...
if ( ! class_exists( 'Surelywp_Tk_Sc_Order_Created' ) ) {
	 ...
	 * @since   1.0.0
	 */
	class Surelywp_Tk_Sc_Order_Created extends BaseTrigger {
		...
		public function __construct() {
			...
			$this->triggerName = 'surecart/order_created';
		...
		public function getTrigger() {
			return array(
				...
				'label'       => esc_html__( 'SureCart - Order Created', 'surelywp-toolkit' ),
				'description' => esc_html__( 'Occurs when an order is created', 'surelywp-toolkit' ),
		...
		public function getSettingsFields( $funnel ) {
			...
			return array(
				'title'     => esc_html__( 'SureCart - Order Created', 'surelywp-toolkit' ),
				'sub_title' => esc_html__( 'Occurs when an order is created', 'surelywp-toolkit' ),
				'fields'    => array(
