<?php
/**
 * Surecart subscription made active.
 *
...
if ( ! class_exists( 'Surelywp_Tk_Sc_Subscription_Made_Active' ) ) {
	 ...
	 * @since   1.0.0
	 */
	class Surelywp_Tk_Sc_Subscription_Made_Active extends BaseTrigger {
		...
		public function __construct() {
			...
			$this->triggerName = 'surecart/subscription_made_active';
		...
		public function getTrigger() {
			return array(
				...
				'label'       => esc_html__( 'SureCart - Subscription Made Active', 'surelywp-toolkit' ),
				'description' => esc_html__( ' Occurs when a subscription\'s status changes to active', 'surelywp-toolkit' ),
		...
		public function getSettingsFields( $funnel ) {
			...
			return array(
				'title'     => esc_html__( 'SureCart - Subscription Made Active', 'surelywp-toolkit' ),
				'sub_title' => esc_html__( 'Occurs when a subscription\'s status changes to active', 'surelywp-toolkit' ),
				'fields'    => array(
