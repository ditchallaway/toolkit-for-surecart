<?php
/**
 * Surecart subscription made trialing.
 *
...
if ( ! class_exists( 'Surelywp_Tk_Sc_Subscription_Made_Trialing' ) ) {
	 ...
	 * @since   1.0.0
	 */
	class Surelywp_Tk_Sc_Subscription_Made_Trialing extends BaseTrigger {
		...
		public function __construct() {
			...
			$this->triggerName = 'surecart/subscription_made_trialing';
		...
		public function getTrigger() {
			return array(
				...
				'label'       => esc_html__( 'SureCart - Subscription Made Trialing', 'surelywp-toolkit' ),
				'description' => esc_html__( 'Occurs when a subscription\'s status changes to trialing', 'surelywp-toolkit' ),
		...
		public function getSettingsFields( $funnel ) {
			...
			return array(
				'title'     => esc_html__( 'SureCart - Subscription Made Trialing', 'surelywp-toolkit' ),
				'sub_title' => esc_html__( 'Occurs when a subscription\'s status changes to trialing', 'surelywp-toolkit' ),
				'fields'    => array(
