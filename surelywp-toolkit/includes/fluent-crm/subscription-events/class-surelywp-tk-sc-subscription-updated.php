...
if ( ! class_exists( 'Surelywp_Tk_Sc_Subscription_Updated' ) ) {
	 ...
	 * @since   1.0.0
	 */
	class Surelywp_Tk_Sc_Subscription_Updated extends BaseTrigger {
		...
		public function __construct() {
			...
			$this->triggerName = 'surecart/subscription_updated';
		...
		public function getTrigger() {
			return array(
				...
				'label'       => esc_html__( 'SureCart - Subscription Updated', 'surelywp-toolkit' ),
				'description' => esc_html__( 'Occurs when a subscription is updated', 'surelywp-toolkit' ),
		...
		public function getSettingsFields( $funnel ) {
			...
			return array(
				'title'     => esc_html__( 'SureCart - Subscription Updated', 'surelywp-toolkit' ),
				'sub_title' => esc_html__( 'Occurs when a subscription is updated', 'surelywp-toolkit' ),
				'fields'    => array(
