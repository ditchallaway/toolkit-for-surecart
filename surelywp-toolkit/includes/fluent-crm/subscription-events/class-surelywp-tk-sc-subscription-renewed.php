...
if ( ! class_exists( 'Surelywp_Tk_Sc_Subscription_Renewed' ) ) {
	 ...
	 * @since   1.0.0
	 */
	class Surelywp_Tk_Sc_Subscription_Renewed extends BaseTrigger {
		...
		public function __construct() {
			...
			$this->triggerName = 'surecart/subscription_renewed';
		...
		public function getTrigger() {
			return array(
				...
				'label'       => esc_html__( 'SureCart - Subscription Renewed', 'surelywp-toolkit' ),
				'description' => esc_html__( ' Occurs when a subscription renews', 'surelywp-toolkit' ),
		...
		public function getSettingsFields( $funnel ) {
			...
			return array(
				'title'     => esc_html__( 'SureCart - Subscription Renewed', 'surelywp-toolkit' ),
				'sub_title' => esc_html__( ' Occurs when a subscription renews', 'surelywp-toolkit' ),
				'fields'    => array(
