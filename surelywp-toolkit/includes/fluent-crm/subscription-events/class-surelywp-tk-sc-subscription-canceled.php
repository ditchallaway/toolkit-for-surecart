<?php
/**
 * Surecart subscription canceled.
 *
...
if ( ! class_exists( 'Surelywp_Tk_Sc_Subscription_Canceled' ) ) {
	 ...
	 * @since   1.0.0
	 */
	class Surelywp_Tk_Sc_Subscription_Canceled extends BaseTrigger {
		...
		public function __construct() {
			...
			$this->triggerName = 'surecart/subscription_canceled';
		...
		public function getTrigger() {
			return array(
				...
				'label'       => esc_html__( 'SureCart - Subscription Canceled', 'surelywp-toolkit' ),
				'description' => esc_html__( 'Occurs when a subscription\'s status changes to canceled', 'surelywp-toolkit' ),
		...
		public function getSettingsFields( $funnel ) {
			...
			return array(
				'title'     => esc_html__( 'SureCart - Subscription Canceled', 'surelywp-toolkit' ),
				'sub_title' => esc_html__( 'Occurs when a subscription\'s status changes to canceled', 'surelywp-toolkit' ),
				'fields'    => array(
