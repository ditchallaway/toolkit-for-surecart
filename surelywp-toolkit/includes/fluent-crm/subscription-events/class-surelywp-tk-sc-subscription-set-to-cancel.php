<?php
/**
 * Surecart subscription set to cancel.
 *
...
if ( ! class_exists( 'Surelywp_Tk_Sc_Subscription_Set_To_Cancel' ) ) {
	 ...
	 * @since   1.0.0
	 */
	class Surelywp_Tk_Sc_Subscription_Set_To_Cancel extends BaseTrigger {
		...
		public function __construct() {
			...
			$this->triggerName = 'surecart/subscription_set_to_cancel';
		...
		public function getTrigger() {
			return array(
				...
				'label'       => esc_html__( 'SureCart - Subscription Set To Cancel', 'surelywp-toolkit' ),
				'description' => esc_html__( 'Occurs when a subscription is set to cancel at the end of the current billing period', 'surelywp-toolkit' ),
		...
		public function getSettingsFields( $funnel ) {
			...
			return array(
				'title'     => esc_html__( 'SureCart - Subscription Set To Cancel', 'surelywp-toolkit' ),
				'sub_title' => esc_html__( 'Occurs when a subscription is set to cancel at the end of the current billing period', 'surelywp-toolkit' ),
				'fields'    => array(
