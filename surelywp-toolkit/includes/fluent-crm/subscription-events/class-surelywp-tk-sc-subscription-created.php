...
if ( ! class_exists( 'Surelywp_Tk_Sc_Subscription_Created' ) ) {
	 ...
	 * @since   1.0.0
	 */
	class Surelywp_Tk_Sc_Subscription_Created extends BaseTrigger {
		...
		public function __construct() {
			...
			$this->triggerName = 'surecart/subscription_created';
		...
		public function getTrigger() {
			return array(
				...
				'label'       => esc_html__( 'SureCart - Subscription Created', 'surelywp-toolkit' ),
				'description' => esc_html__( 'Occurs when a subscription is created', 'surelywp-toolkit' ),
		...
		public function getSettingsFields( $funnel ) {
			...
			return array(
				'title'     => esc_html__( 'SureCart - Subscription Created', 'surelywp-toolkit' ),
				'sub_title' => esc_html__( 'Occurs when a subscription is created', 'surelywp-toolkit' ),
				'fields'    => array(
