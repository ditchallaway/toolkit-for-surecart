...
if ( ! class_exists( 'Surelywp_Tk_Sc_Refund_Created' ) ) {
	 ...
	 * @since   1.0.0
	 */
	class Surelywp_Tk_Sc_Refund_Created extends BaseTrigger {
		...
		public function __construct() {
			...
			$this->triggerName = 'surecart/refund_created';
		...
		public function getTrigger() {
			return array(
				...
				'label'       => esc_html__( 'SureCart - Refund Created', 'surelywp-toolkit' ),
				'description' => esc_html__( 'Occurs when a refund is created', 'surelywp-toolkit' ),
		...
		public function getSettingsFields( $funnel ) {
			...
			return array(
				'title'     => esc_html__( 'SureCart - Refund Created', 'surelywp-toolkit' ),
				'sub_title' => esc_html__( 'Occurs when a refund is created', 'surelywp-toolkit' ),
				'fields'    => array(
