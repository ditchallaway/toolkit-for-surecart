<?php
/**
 * Vacation mode notice block Root file.
 *
 * @package Discounts For SureCart
 */
 ...
 * @since 1.0.0
 */
function create_block_surelywp_tk_vm_notice() {
	register_block_type( __DIR__ . '/build' );
}
add_action( 'init', 'create_block_surelywp_tk_vm_notice' );
